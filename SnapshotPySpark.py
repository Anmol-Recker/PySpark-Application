...
spark = SparkSession.builder.master("local").appName("Debtors Task").getOrCreate()

Snapshot = spark.read.format("csv").option("header", "true").load("file:///home/anmol/SnapShot.csv")
